...
namespace TryIt_All_Services
{
    public partial class _Default : Page
    {
        ...
        protected void btn_Stemming_Click(object sender, EventArgs e)
        {
            ...
            lbl_Stemming.Text = prxy.Stemming(txtbox_Stemming.Text);
        }
        ...
        {
            MyService.Service1Client prxy = new MyService.Service1Client();
            lbl_WordFilter.Text = prxy.WordFilter(txtbox_WordFilter.Text);
        }

        protected void btn_String_Sort_Click(object sender, EventArgs e)
        {
            MyService.Service1Client prxy = new MyService.Service1Client();
